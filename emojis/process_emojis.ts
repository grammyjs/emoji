...
function parseEmojiList() {
    // Split by new line
    const lines = Deno.readTextFileSync("./src/emojis/emojis.txt").split("\n");
...
Deno.writeFile("./src/emojis/emojis.json", new TextEncoder().encode(JSON.stringify(parseEmojiList())));
