import { type Context, type Middleware } from "./deps.deno.ts";
...
export function emojiParser<C extends Context>(): Middleware<EmojiFlavor<C>> {
    return async (ctx: EmojiFlavor<C>, next) => {
        Object.assign(ctx, {
            emoji: withEmoji,
            replyWithEmoji: (
